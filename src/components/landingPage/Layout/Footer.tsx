...
const Footer = () => {
  return (
    <div className="bg-gradient-to-r from-blue-500 to-blue-400 pt-44 pb-24">
      <div className="max-w-screen-xl w-full mx-auto px-6 sm:px-8 lg:px-16 grid grid-rows-6 sm:grid-rows-1 grid-flow-row sm:grid-flow-col grid-cols-2 sm:grid-cols-12 gap-4">
        <div className="row-span-2 sm:col-span-4 col-start-1 col-end-4 sm:col-end-5 flex flex-col items-start gap-4 -mt-8">
          ...
          <p className="text-gray-400 -mt-4">©{new Date().getFullYear()} - Twezimbe</p>
        </div>
        <div className=" row-span-2 sm:col-span-2 sm:col-start-7 sm:col-end-9 flex flex-col">
          <p className="text-white-500 mb-4 font-medium text-lg">Company</p>
          <ul className="text-black-500 ">
            <li className="my-2 hover:text-[rgb(50,86,166)] text-gray-400 cursor-pointer transition-all">
              Home{" "}
            </li>
            <li className="my-2 hover:text-[rgb(50,86,166)] text-gray-400 cursor-pointer transition-all">
              About Us{" "}
        ...
        <div className="row-span-2 sm:col-span-2 sm:col-start-11 sm:col-end-13 flex flex-col">
          <p className="text-white-500 mb-4 font-medium text-lg">Get In Touch</p>
          <ul className="text-black-500">
            <li className="my-2 hover:text-[rgb(50,86,166)] text-gray-400 cursor-pointer transition-all">
