...
const UserProfileForm = ({ onSave, isLoading, currentUser }: Props) => {
    ...
    const onSubmit = (UserProfileData: UserFormData) => {
        var newData = {
            ...UserProfileData,
            title: title?.value,
        ...
        console.log("submit", newData?.birthday);
        onSave(newData)
    }
        ...
        <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className='space-y-2 bg-gray-50 rounded-lg md:p-10'>
                            ...
                            <FormItem className='w-[31%]'>
                                ...
                                <FormControl>
                                    ...
                                    <Datepicker options={{
                                        ...
                                        defaultDate: new Date(field?.value) as Date,
                ...
                <div className='flex flex-wrap w-full justify-between items-start gap-3'>
                    ...
                    {/* Additional fields for group membership information */}


                    {/* Additional fields for consent and agreements */}
                    ...
                    {/* Additional fields for custom fields */}
